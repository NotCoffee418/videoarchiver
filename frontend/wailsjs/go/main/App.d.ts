...
export function ClearAllRegisteredFiles():Promise<void>;
...
export function GetRegisteredFiles(arg1:number,arg2:number):Promise<Array<main.RegisteredFile>>;
...
export function RegisterDirectory(arg1:string):Promise<void>;
